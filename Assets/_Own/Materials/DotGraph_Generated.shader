        ...
        SubShader
{
    ...
    SurfaceDescription PopulateSurfaceData(SurfaceDescriptionInputs IN)
    {
        ...
        float4 _Multiply_4D8F079C_Out;
        Unity_Multiply_float(_SampleTexture2D_E713EA74_RGBA, IN.VertexColor, _Multiply_4D8F079C_Out);

        float _Split_7535A2B5_R = _Multiply_4D8F079C_Out[0];
        float _Split_7535A2B5_G = _Multiply_4D8F079C_Out[1];
        float _Split_7535A2B5_B = _Multiply_4D8F079C_Out[2];
        float _Split_7535A2B5_A = _Multiply_4D8F079C_Out[3];
        ...
        float _Split_36216FCD_R = IN.VertexColor[0];
        float _Split_36216FCD_G = IN.VertexColor[1];
        float _Split_36216FCD_B = IN.VertexColor[2];
        float _Split_36216FCD_A = IN.VertexColor[3];
        float _Divide_A8A20A6C_Out;
        Unity_Divide_float(_Property_C9327209_Out, _Split_36216FCD_A, _Divide_A8A20A6C_Out);
        surface.Color = _Multiply_C4824BBA_Out;
        surface.Alpha = _Split_7535A2B5_A;
        surface.AlphaClipThreshold = _Divide_A8A20A6C_Out;
        return surface;
    }
